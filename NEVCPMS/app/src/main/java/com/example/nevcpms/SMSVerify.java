...
import com.example.nevcpms.util.DemoResHelper;
...
public class SMSVerify extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s_m_s_verify_layout);
        initViews();
        initListener();
        ...
        tvCountry.setText("中国" + " +" + DEFAULT_COUNTRY[2]);
    ...
    private void initListener() {
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (tvCode != null) {
                    if (currentSecond > 0) {
                        tvCode.setText("获取验证码" + " (" + currentSecond + "s)");
                        tvCode.setEnabled(false);
                        currentSecond--;
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (result == SMSSDK.RESULT_COMPLETE) {
                                Intent intent=new Intent(SMSVerify.this,MainActivity.class);
                            } else {
                                processError(data);
                            }
                        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ivSelectCountry:
                ...
                countryPage.showForResult(SMSVerify.this, null, callback);
                break;
            case R.id.tvVerify:
                if (!isNetworkConnected()) {
                    Toast.makeText(SMSVerify.this, getString(R.string.smssdk_network_error), Toast.LENGTH_SHORT).show();
                    break;
                }
